...
#define HCL_CPP_REGION_UPDATE(name, key, value) HCL_NOOP_MACRO
#define HCL_CPP_BLOCK_START(name) HCL_NOOP_MACRO
#define HCL_CPP_BLOCK_END(name) HCL_NOOP_MACRO
#define HCL_CPP_BLOCK_UPDATE(name, key, value) HCL_NOOP_MACRO
#define HCL_PROFILER_CPP_INIT(logfile) HCL_NOOP_MACRO
...
#define HCL_CPP_BLOCK_UPDATE(name, key, value) \
...
#define HCL_C_REGION_UPDATE_INT(name, key, value) HCL_NOOP_MACRO
#define HCL_C_REGION_UPDATE_STR(name, key, value) HCL_NOOP_MACRO
